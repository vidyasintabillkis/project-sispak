...
class AuthController extends Controller
{
    ...
    public function logout()
    {
        ...
        return redirect()->to(site_url('/sign_in'));
    }
    ...
    public function attemptRegister()
    {
        ...
        if ($this->config->requireActivation !== null) {
            ...
            // Success!
            return redirect()->route('sign_in')->with('message', lang('Auth.activationSuccess'));
        }

        // Success!
        return redirect()->route('sign_in')->with('message', lang('Auth.registerSuccess'));
    }
