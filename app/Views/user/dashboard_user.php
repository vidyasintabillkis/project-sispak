...
<body>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
			...
			<li><a href="<?= base_url('/user') ?>" class="active"><i class='bx bxs-dashboard icon'></i> Beranda</a></li>
			...
			<?php for ($i = 1; $i <= count($artikel); $i++) : ?>
				...
				<div class="card mr-2" style="width: 20rem;">
					...
					<div class="card-body">
						...
						<a href="<?= base_url('lihat_article/' . $artikel[$i - 1]['id']) ?>" class="btn btn-primary btn-sm">Selengkapnya</a>
					</div>
				</div><br>
				<?php if ($i % 3 == 0) : ?>
			<?php endif;
