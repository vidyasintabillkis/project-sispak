                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="basic">
                                                    <form class="form-horizontal" role="form">
                                                        ...
                                                        <br>
                                                        <div class="form-group">
                                                            <label for="gejala1" class="col-lg-2 control-label">Gejala 1</label>
                                                            <div class="col-lg-12">
                                                                <select class="form-control" name="gejala1" value="">
                                                                    <option selected disabled>Pilih Gejala 1</option>
                                                                    <option value="1">One</option>
                                                                    <option value="2">Two</option>
                                                                    <option value="3">Three</option>
                                                                </select>
                                                        ...
                                                        <br>
                                                        <div class="form-group">
                                                            <label for="gejala2" class="col-lg-2 control-label">Gejala 2</label>
                                                            <div class="col-lg-12">
                                                                <select class="form-control" name="gejala2" value="">
                                                                    <option selected disabled>Pilih Gejala 2</option>
                                                                    <option value="1">One</option>
                                                                    <option value="2">Two</option>
                                                                    <option value="3">Three</option>
                                                                </select>
